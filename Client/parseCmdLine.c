...
int parseCmdLine(int argc, char *argv[], pCallback p, void *userData, unsigned int shift)
{
	int i = shift, status = OK, parsedArgs = 0;				// i : indice para el arreglo de argumentos.
