...
typedef enum { NO_EV, PUT, GET, QUIT, HELP, CLEAR, EMPTY_COMMAND, INVALID, FILE_ERROR, ERROR, DATA, ACK, WRQ, RRQ, SEND_ERROR ,RECEIVE_ERROR, LAST_DATA, TIMEOUT } eventCode;
